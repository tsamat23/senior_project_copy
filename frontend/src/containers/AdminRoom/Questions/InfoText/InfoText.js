...
import {styles} from './InfoTextStyles-material-ui';
            ...
            <div className={classes.root}>
                <ExpansionPanel>
                    ...
                    <ExpansionPanelDetails className={classes.body}>
                        ...
                        <Editor
                            toolbarHidden
                            contentState={JSON.parse(this.props.data)}
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(InfoText));