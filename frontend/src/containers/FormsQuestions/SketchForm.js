    ...
    render() {
        ...
        return(
            <div>
                ...
                >
                    <DialogTitle id="form-dialog-title">Форма добавления вопроса с ответом в виде рисунка</DialogTitle>
...
export default connect(null, mapDispatchToProps)(withStyles(styles)(Simple));